                        ...
                        if ($category->show_on_main_menu == 1):
                            ...
                            if ($count <= $limit):?>
                                <li class="nav-item dropdown" data-category-id="<?php echo $category->id; ?>">
                                    <a id="nav_main_category_<?= $category->id; ?>"
                                                    ...
                                                    <div class="card-columns">
                                                        <?php foreach ($subcategories as $subcategory):
                                                            ...
                                                            <div class="card">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <a id="nav_main_category_<?= $subcategory->id; ?>"
                                                                           href="<?php echo generate_category_url($subcategory); ?>"
                                                                           class="second-category nav-main-category"
                                                                           data-id="<?= $subcategory->id; ?>"
                                                                           data-parent-id="<?= $subcategory->parent_id; ?>"
                                                                           data-has-sb="<?= !empty($subcategory->has_subcategory) ? '1' : '0'; ?>"><?php echo category_name($subcategory); ?></a>
                                                                        <?php
                                                                        ...
                                                                        if (!empty($third_categories)):
                                                                            ...
                                                                            <ul>
                                                                                <?php foreach ($third_categories as $third_category):
                                                                                    ...
                                                                                    <li>
                                                                                        <a id="nav_main_category_<?= $third_category->id; ?>"
                                                                                           href="<?php echo generate_category_url($third_category); ?>"
                                                                                           class="nav-main-category <?= ($display_limit > $menu_subcategory_display_limit) ? 'hidden' : ''; ?>"
                                                                                           data-id="<?= $third_category->id; ?>"
                                                                                           data-parent-id="<?= $third_category->parent_id; ?>"
                                                                                           data-has-sb="0"><?= category_name($third_category); ?></a>
                                                                                    </li>
                                                                                    <?php $display_limit++;
                                                                                endforeach; ?>
                                                                                <?php if ($display_limit > $menu_subcategory_display_limit): ?>
                                                                                    <li>
                                                                                        <a href="<?php echo generate_category_url($subcategory); ?>"
                                                                                           class="link-view-all"><?php echo trans("show_all"); ?></a>
                                                                                    </li>
                                                                                <?php endif; ?>
                                                                            </ul>
                                                                        <?php endif; ?>
                                                        ...
                                                        <div class="nav-category-image">
                                                            <a href="<?php echo generate_category_url($image_category); ?>">
                                                                <img src="<?php echo base_url() . IMG_BG_PRODUCT_SMALL; ?>"
                                                                     data-src="<?php echo get_category_image_url($image_category); ?>"
                                                                     alt="<?php echo category_name($image_category); ?>"
                    ...
                    if (item_count($this->parent_categories) > $limit): ?>
                        <li class="nav-item dropdown menu-li-more">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="true" aria-expanded="false"><?php echo trans("more"); ?></a>
                                        ...
                                        if ($category->show_on_main_menu == 1):
                                            if ($count > $limit):?>
                                                <a href="<?php echo generate_category_url($category); ?>"
                                                   ...
                                                   data-parent-id="<?= $category->parent_id; ?>"
                                                   data-has-sb="<?= !empty($category->has_subcategory) ? '1' : '0'; ?>"><?php echo category_name($category); ?></a>
                                                <?php $subcategories = !empty($this->categories_array[$category->id]) ? $this->categories_array[$category->id] : null;
                                                if (!empty($subcategories)):
                                                    foreach ($subcategories as $subcategory): ?>
                                                        <a id="nav_main_category_<?= $subcategory->id; ?>"
                                                           href="<?php echo generate_category_url($subcategory); ?>"
                                                           class="hidden" data-id="<?= $subcategory->id; ?>"
                                                           data-parent-id="<?= $subcategory->parent_id; ?>"
                                                           data-has-sb="<?= !empty($subcategory->has_subcategory) ? '1' : '0'; ?>"><?php echo category_name($subcategory); ?></a>
                                                        ...
                                                        if (!empty($third_categories)):
                                                            foreach ($third_categories as $third_category): ?>
                                                                <a id="nav_main_category_<?= $third_category->id; ?>"
                                                                   href="<?php echo generate_category_url($third_category); ?>"
                                                                   class="hidden" data-id="<?= $third_category->id; ?>"
                                                                   data-parent-id="<?= $third_category->parent_id; ?>"
                                                                   data-has-sb="0"><?= category_name($third_category); ?></a>
                                                            <?php endforeach;
                                                        endif;
                        ...
                        if ($menu_item_count <= $limit):?>
                            <li class="nav-item dropdown" data-category-id="<?php echo $category->id; ?>">
                                <a id="nav_main_category_<?= $category->id; ?>"
                                   ...
                                   data-has-sb="<?= !empty($category->has_subcategory) ? '1' : '0'; ?>"><?php echo category_name($category); ?>
                                    <?php if (!empty($category->has_subcategory)): ?>
                                        <i class="nav-item-arrow icon-arrow-down"
                                           data-category-id="<?php echo $category->id; ?>"
                                           data-id="<?= $category->id; ?>" data-parent-id="<?= $category->parent_id; ?>"
                                           data-has-sb="<?= !empty($category->has_subcategory) ? '1' : '0'; ?>"></i>
                                    <?php endif; ?>
                                    ...
                                    <div id="mega_menu_content_<?php echo $category->id; ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-4 left">
                                                <?php $count = 0;
                                                foreach ($subcategories as $subcategory): ?>
                                                    <div class="large-menu-item <?php echo ($count == 0) ? 'large-menu-item-first active' : ''; ?>"
                                                        ...
                                                        <a id="nav_main_category_<?= $subcategory->id; ?>"
                                                           ...
                                                           data-id="<?= $subcategory->id; ?>"
                                                           data-parent-id="<?= $subcategory->parent_id; ?>"
                                                           data-has-sb="<?= !empty($subcategory->has_subcategory) ? '1' : '0'; ?>"><?php echo category_name($subcategory); ?>
                                            ...
                                            <div class="col-8 right">
                                                ...
                                                $count = 0;
                                                foreach ($subcategories as $subcategory): ?>
                                                    <div id="large_menu_content_<?php echo $subcategory->id; ?>"
                                                         class="large-menu-content <?php echo ($count == 0) ? 'large-menu-content-first active' : ''; ?>">
                                                        <?php $third_categories = !empty($this->categories_array[$subcategory->id]) ? $this->categories_array[$subcategory->id] : null;
                                                        if (!empty($third_categories)): ?>
                                                            <div class="row">
                                                                <div class="card-columns">
                                                                    <?php foreach ($third_categories as $third_category): ?>
                                                                        <div class="card item-large-menu-content">
                                                                            <a id="nav_main_category_<?= $third_category->id; ?>"
                                                                               ...
                                                                               data-id="<?= $third_category->id; ?>"
                                                                               data-parent-id="<?= $third_category->parent_id; ?>"
                                                                               data-has-sb="0"><?php echo category_name($third_category); ?></a>
                                                                            <?php $i = 1;
                                                                            ...
                                                                            if (!empty($fourth_categories)): ?>
                                                                                <ul>
                                                                                    <?php foreach ($fourth_categories as $fourth_category): ?>
                                                                                        <li>
                                                                                            <a id="nav_main_category_<?= $fourth_category->id; ?>"
                                                                                               href="<?php echo generate_category_url($fourth_category); ?>"
                                                                                               class="nav-main-category <?= ($i > $menu_subcategory_display_limit) ? 'hidden' : ''; ?>"
                                                                                               data-id="<?= $fourth_category->id; ?>"
                                                                                               data-parent-id="<?= $fourth_category->parent_id; ?>"
                                                                                               data-has-sb="0"><?= category_name($fourth_category); ?></a>
                                                                                        </li>
                                                                                        <?php $i++;
                                                                                    endforeach; ?>
                                                                                </ul>
