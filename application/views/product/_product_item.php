...
*/ ?>
<div id="product-card" class="product-card product-item">
    ...
    font-weight: bold;" class="product-title text-truncate">
        ...
        <div class="product-info">
            ...
            <div>
                <a id="wishlist-button"  href="javascript:void(0)" style="display:inline-flex" class="item-option btn-add-remove-wishlist"
                   data-toggle="tooltip"
...
<script>
    ...
    productCard.onclick = function() {
        window.location.href = '<?= generate_product_url($product); ?>';
    };
