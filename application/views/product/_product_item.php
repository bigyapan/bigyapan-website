...
<!--<div class="product-item">
    <div class="row-custom<?php /*echo (!empty($product->image_second)) ? ' product-multiple-image' : ''; */?>">
        <a class="item-wishlist-button item-wishlist-enable <?php /*echo (is_product_in_wishlist($product) == 1) ? 'item-wishlist' : ''; */?>"
...
<div class="product-card product-item">
    ...
    <div class="product-content">
        ...
        <div class="product-info">
            ...
            <div>
                <a style="display:inline-flex" href="javascript:void(0)" class="item-option btn-add-remove-wishlist" data-toggle="tooltip"
